...
import loaderCat from '@/public/img/lottie/Loader cat.json';
...
export default function Services() {
  ...
  return (
    <section id="servicios" ref={ref} className="py-20 bg-gradient-to-b from-white via-[#F8F9F9] to-white relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#A9DFBF]/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#7FB3D5]/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              >
                ...
                <div className="absolute inset-0 w-full h-full">
                  {service.img ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-[#7FB3D5] via-[#A9DFBF] to-[#7FB3D5]"></div>
                  )}
                </div>
                ...
                <div className="relative h-full flex flex-col justify-end p-6 md:p-8">
                  ...
                  >
                    ...
                    >
                      ...
                      <a
                        href="#cita"
                        className="inline-flex items-center gap-2 bg-white text-[#154360] px-6 py-3 rounded-full font-bold text-sm uppercase tracking-wide hover:bg-[#F8F9F9] transition-colors"
                      >
        ...
        >
          <div className="relative overflow-hidden bg-gradient-to-br from-[#5A9FBF] to-[#7FB3D5] rounded-3xl p-8 md:p-12 shadow-2xl">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-white text-[#154360] px-8 py-3 rounded-full font-bold text-base transition-all hover:scale-105 shadow-2xl hover:shadow-white/50"
                >
            ...
            <div className="pointer-events-none hidden md:block md:absolute md:-bottom-10 md:-right-8 md:w-80 md:h-80">
              <Lottie
