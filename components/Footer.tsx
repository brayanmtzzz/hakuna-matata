        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-emerald-400">Veterinaria Profesional</span>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="bg-white/10 hover:bg-emerald-500 p-3 rounded-full transition-all hover:scale-110 hover:shadow-lg hover:shadow-emerald-500/50"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#nosotros" className="text-gray-400 hover:text-emerald-400 transition-colors hover:translate-x-1 inline-block">
                  Nosotros
                </Link>
              </li>
              <li>
                <Link href="#servicios" className="text-gray-400 hover:text-emerald-400 transition-colors hover:translate-x-1 inline-block">
                  Servicios
                </Link>
              </li>
              <li>
                <Link href="#cita" className="text-gray-400 hover:text-emerald-400 transition-colors hover:translate-x-1 inline-block">
                  Agenda tu Cita
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start space-x-2">
                ...
                <a href="tel:9242105259" className="hover:text-emerald-400 transition-colors">
                  924 210 5259
                </a>
              </li>
              <li className="flex items-start space-x-2">
